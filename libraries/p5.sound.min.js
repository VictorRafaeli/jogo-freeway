...
!(function (n) {
                    ...
                    return (
                        ...
                        (u.TimelineSignal.prototype.exponentialRampToValueAtTime = function (t, e) {
                            ...
                            return (
                                ...
                                t < this._minOutput
                                    ? (this._param.exponentialRampToValueAtTime(this._minOutput, e - this.sampleTime), this.setValueAtTime(0, e))
                ...
                (r = function (r) {
                    ...
                    return (
                        ...
                        (r.Clock.prototype.start = function (t, e) {
                            return (
                                (t = this.toSeconds(t)),
                                this._state.getValueAtTime(t) !== r.State.Started && this._state.add({ state: r.State.Started, time: t, offset: e }),
                                this
                            );
                        }),
                ...
                (r = function (t) {
                    ...
                    return (
                        ...
                        (t.GreaterThanZero.prototype.dispose = function () {
                            return (
                                t.prototype.dispose.call(this), this._scale.dispose(), (this._scale = null), this._thresh.dispose(), (this._thresh = null), this
                            );
                        }),
                        t.GreaterThanZero
                    );
        ...
        function l(t) {
            ...
            this.parameters.forEach(function (t, e) {
                ...
                this.processor.realm.exec(
                    "self.sampleRate=sampleRate=" + this.context.sampleRate + ";self.currentTime=currentTime=" + this.context.currentTime
                );
    ...
    function (t, e, n) {
                ...
                return (
                    (function (t, e, n) {
                    ...
                    })(n, [
                        {
                            ...
                            value: function (t) {
                                t
                                    ? (t.output ? t.output.connect(this.analyser) : t.connect && t.connect(this.analyser), p.fftMeter.disconnect())
                                    : p.fftMeter.connect(this.analyser);
                            },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                for (
                                    var e = p.audiocontext.sampleRate / 2, n = this.freqDomain, i = n.length, r = new Array(t.length), o = 0, s = 0;
                                    s < i;
                                    s++
                                ) {
        ...
        (p5.Envelope = function (t, e, n, i, r, o) {
            ...
            (p5.Envelope.prototype.ramp = function (t, e, n, i) {
                ...
                a < o
                    ...
                    void 0 !== s &&
                        (o < s ? this.control.setTargetAtTime(s, r, this._rampAttackTC) : s < o && this.control.setTargetAtTime(s, r, this._rampDecayTC));
            }),
        ...
        var ht = (function () {
                for (
                    var t = 2 * p.audiocontext.sampleRate, e = p.audiocontext.createBuffer(1, t, p.audiocontext.sampleRate), n = e.getChannelData(0), i = 0;
                    i < t;
                    i++
                )
                    n[i] = 2 * Math.random() - 1;
        ...
        (p5.prototype.getAudioContext = c.b),
            ...
            (p5.prototype.soundFormats = function () {
                ...
                for (var t = 0; t < arguments.length; t++) {
                    if (((arguments[t] = arguments[t].toLowerCase()), !(-1 < ["mp3", "wav", "ogg", "m4a", "aac"].indexOf(arguments[t]))))
